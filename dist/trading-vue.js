/*!
 * TradingVue.JS - v1.0.3 - Thu Jun 18 2026
...
/* harmony default export */ const utils = ({
  ...
  calculate_data_index_without_ti_map: function calculate_data_index_without_ti_map(array, target, tf) {
    ...
    var found = false;
    var interval_ms = this.detect_interval(array); // console.log("searchResults",interval_ms)
    ...
    var targetDate = new Date(target).toLocaleString(); // Target not found, determine which side it would be on and calculate the difference
    ...
    if (target < GetValue(left)) {
      side = 'left'; // difference = array[left] - target;
...
/* harmony default export */ const log_scale = ({
  ...
  expand: function expand(self, height) {
    var hi = self.$_hi;
    var lo = self.$_lo; // Check if both high and low are negative
    ...
    if (hi < 0 && lo < 0) {
      ...
      var top = -height * 0.1;
      var bot = height * 1.1; // Shift back to the negative domain using negative exponentiation
...
var Grid = /*#__PURE__*/function () {
  function Grid(canvas, comp) {
    ...
    this.wmode = this.$p.config.SCROLL_WHEEL; // if (this.$p.enableZoom) {
...
var Crosshair = /*#__PURE__*/function () {
  ...
  createClass_createClass(Crosshair, [{
    ...
    value: function draw(ctx) {
      // Update reference to the grid
      this.layout = this.$p.layout;
      var cursor = this.comp.$props.cursor; // console.log(this.vis)
...
/* harmony default export */ const Splinevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    draw: function draw(ctx) {
      ctx.lineWidth = this.line_width; // console.log("this.line_type",this.line_type)

      ctx.strokeStyle = this.color;
      ctx.beginPath(); //--- line style
  ...
  mounted: function mounted() {//console.log("Spline Mounted")
  }
});
...
var Price = /*#__PURE__*/function () {
  ...
  createClass_createClass(Price, [{
    ...
    value: function init_shader() {
      ...
      this.comp.$emit('new-shader', {
        ...
        draw: function draw(ctx) {
          ...
          var x = -0.5;
          var a = 7; // let isArrow = comp.$props.settings

          if (comp !== null && comp !== void 0 && comp.isArrow) {
            //y according to arrow
            var y = bar.y - h * 0 - 0.5; //map client arrow work
            ...
            ctx.fillStyle = bar.color;
            ctx.font = "15px''";
            ctx.beginPath(); //1. ctx.moveTo(0,16);

            ctx.moveTo(x - 0.5, y); //2. ctx.lineTo(19,0);

            ctx.lineTo(x - 0.5 + 19, y - 16); //3. ctx.lineTo(66.5,0);

            ctx.lineTo(x - 0.5 + 19 + 66.5, y - 16); //4. ctx.lineTo(66.5,35);

            ctx.lineTo(x - 0.5 + 19 + 66.5, y + 32 - 16); //5. ctx.lineTo(19,35);

            ctx.lineTo(x - 0.5 + 19, y + 32 - 16); //6. ctx.lineTo(0,16);
            ...
            ctx.textAlign = 'left'; //for arrow work
    ...
    value: function drawArrow(ctx, fromx, fromy, tox, toy, arrowWidth, color) {
      ...
      ctx.stroke(); //starting a new path from the head of the arrow to one of the sides of
      //the point

      ctx.beginPath();
      ctx.moveTo(tox, toy);
      ctx.lineTo(tox - headlen * Math.cos(angle - Math.PI / 4), toy - headlen * Math.sin(angle - Math.PI / 4)); //path from the side point of the arrow, to the other side point

      ctx.lineTo(tox - headlen * Math.cos(angle + Math.PI / 4), toy - headlen * Math.sin(angle + Math.PI / 4)); //path from the side point back to the tip of the arrow, and then
      //again to the opposite side point

      ctx.lineTo(tox, toy);
      ctx.lineTo(tox - headlen * Math.cos(angle - Math.PI / 4), toy - headlen * Math.sin(angle - Math.PI / 4)); //draws the paths created above
...
/* harmony default export */ const Candlesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    y_range: function y_range() {
      ...
      var yRange = [hi, lo]; // console.log("yRange",yRange)
  ...
  mounted: function mounted() {//console.log("candles mounted", this.$props);
  }
});
...
/* harmony default export */ const Gridvue_type_script_lang_js_ = ({
  ...
  watch: {
    enableZoom: function enableZoom() {// console.log("props:",enableZoom);
    },
    // enableCrosshair() {
...
var Legendvue_type_template_id_34724886_render = function() {
  ...
  return _c(
    ...
    [
      _vm.grid_id === 0 && !_vm.showTitleChartLegend
        ? _c(
            "div",
            {
            ...
            [
              _vm.common &&
              _vm.common.showLegendPropsData &&
              _vm.common.showLegendPropsData.length
                ? [
                    _vm._l(_vm.common.showLegendPropsData, function(n, i) {
                      return _c("b", { key: i }, [
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.show_CustomProps
                ? _vm._l(_vm.legendTxtConfig, function(n, i) {
                    return _c("span", { key: i, style: n.style }, [
              ...
              !_vm.show_CustomProps
                ...
                : _vm._e(),
              _vm._v(" "),
              _c("span", { staticClass: "t-vue-exchange" }, [
                _vm._v(
                  "\n            " +
              ...
              _vm._v(" "),
              _vm.show_values && !_vm.show_CustomProps
                ? _c("span", [
                    _vm._v("\n            O"),
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.isButtonvisible && _vm.isOverlayCollapsed
        ? _c(
            "button",
            {
              staticClass: "p-button p-component p-button-sm collapse-btn",
              staticStyle: { cursor: "pointer", "pointer-events": "all" },
              attrs: { type: "button" },
              on: {
            ...
            [
              ...
              _c("span", { staticClass: "p-button-label" }, [
                _vm._v(_vm._s(this.indicators.length))
              ])
            ]
          )
        : _vm._e(),
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      ind.loading
                        ? _c("spinner", {
                            attrs: { colors: _vm.common.colors }
                          })
                        : _vm._e()
                    ],
                    1
      ...
      _vm.isButtonvisible && !_vm.isOverlayCollapsed
        ? _c(
            ...
            [_c("span", { staticClass: "pi pi-angle-up p-button-icon" })]
          )
        : _vm._e()
    ]
  )
...
/* harmony default export */ const Legendvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    ohlcv: function ohlcv() {
      ...
      var prec = this.decimalPlace; // const prec = 3
...
/* harmony default export */ const Sectionvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    grid_props: function grid_props() {
      ...
      if (id > 0) {
        ...
        var all = p.data; // p.data = [p.data[id - 1]]

        p.data = [p.data.filter(function (d) {
          return !_this.hasGridId(d);
        })[id - 1]]; // Merge offchart overlays with custom ids with
    ...
    section_values: function section_values() {
      var id = this.$props.grid_id; // console.log("section_values")
    ...
    legend_props: function legend_props() {
      ...
      if (id > 0) {
        ...
        var all = p.data;
        p.offchart = all; // p.data = [p.data[id - 1]];
        ...
        var showLegendProps = localStorage.getItem('showLegendProps'); // console.log('legendTxtConfig',legendTxtConfig)

        if (this.$props.ignore_OHLC && legendTxtConfig) {
          res = JSON.parse(legendTxtConfig); //console.log('parse response ',res)
        }
        ...
        p.showSettingsMain = showSettingsMain; // console.log(JSON.stringify({a:p.show_CustomProps,b:p.legendTxtConfig,mainType}))
      }
  ...
  mounted: function mounted() {
    this.init_shaders(this.$props.common.skin); // console.log('common.data',this.meta_props)
  },
  methods: {
...
var Botbar = /*#__PURE__*/function () {
  ...
  createClass_createClass(Botbar, [{
    ...
    value: function panel() {
      ...
      var cursor = this.$p.cursor.x; // let x = Math.floor(cursor - panwidth * 0.5)

      var x = Math.floor(cursor); // console.log(x,cursor,panwidth)

      var y = -0.5;
      var panheight = this.comp.config.PANHEIGHT;
      this.ctx.fillRect(x, y, panwidth, panheight + 0.5);
      this.ctx.fillStyle = this.$p.colors.textHL; // this.ctx.textAlign = 'center'
...
var TI = /*#__PURE__*/function () {
  ...
  createClass_createClass(TI, [{
    ...
    value: function t2i(t) {
      ...
      var res = this.ti_map[t]; // console.log("t2i Discrete mapping",res)

      if (res !== undefined) return res;
      var t0 = this.sub[0][0];
      var tN = this.sub[this.sub.length - 1][0]; // console.log("t2i value",{t0,tN})
      // Linear extrapolation
...
/* harmony default export */ const Chartvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    auto_y_axis: function auto_y_axis() {
      var gridKeys = Object.keys(this.y_transforms); // console.log("gridKeys", gridKeys)
  ...
  watch: {
    ...
    data: {
      handler: function handler(n, p) {
        ...
        var sub = this.subset(this.range, 'subset dataset'); // Fixes Infinite loop warn, when the subset is empty
  ...
  methods: {
    range_changed: function range_changed(r, manualInteraction) {
      ...
      if (manualInteraction) {} // console.log('this.range before update',this.range)
    ...
    range_changed_by_time: function range_changed_by_time(startTime, endTime) {
      ...
      var dataChanged = this.data_changed(); // console.log("range_changed_by_time dataChanged", dataChanged)

      var startTimeIndex = this.ti_map.t2i(startTime);
      var endTimeIndex = this.ti_map.t2i(endTime); // console.log("range_changed_by_time updatedIndex", {
      //   dataChanged, startTimeIndex, endTimeIndex
      // })

      var newRange = [startTimeIndex, endTimeIndex];
      this.range_changed(newRange); // console.log('this.ti_map.t2i(r[0])',this.ti_map.t2i(r[0]))
    },
    ...
    calc_interval: function calc_interval(caller) {
      ...
      var detected = utils.detect_interval(this.ohlcv);

      if (!isFinite(detected) || detected === 0) {
        detected = tf || constants.DAY;
      }

      this.interval_ms = tf || detected;
      this.interval = this.$props.ib ? 1 : this.interval_ms; // console.log("calc_interval", {
      //   interval: this.interval,
    ...
    default_range: function default_range() {
      ...
      if (!this.$props.ib) {
        ...
        var newArr = [s - this.interval * d, l + this.interval * ml]; // console.log("this.forced_initRange", this.forced_initRange)

        if (this.forced_initRange) {
          newArr = this.forced_initRange;
        } else {
          var _this$chart, _this$chart2, _this$chart2$initRang;
    ...
    subset: function subset(range, type) {
      ...
      if (res) {
        ...
        if (!this.$props.ib) return res || []; // console.log("subset "+type,{
    ...
    toggleSidebarCustomRange: function toggleSidebarCustomRange(vericalRange) {
      ...
      this.update_layout();
      this.$emit('sidebar-transform', this.y_transforms['0']); // const lay = new Layout(this)
    ...
    toggleSideBarYAxis: function toggleSideBarYAxis() {
      ...
      if (gridKeys.length > 0 && gridKeys.includes("0")) {
        ...
        this.update_layout();
        this.$emit('sidebar-transform', this.y_transforms['0']); // console.log("noideawill", this.y_transforms['0'], gridKeys)
      } else {
  ...
  mounted: function mounted() {//console.log(this._layout)
  }
});
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/TitleLegend.vue?vue&type=template&id=626f37f6&
var TitleLegendvue_type_template_id_626f37f6_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "trading-vue-legend title-legend" }, [
    _vm.grid_id === 0
      ? _c(
          "div",
          { staticClass: "trading-vue-ohlcv" },
...
var TitleLegendvue_type_template_id_626f37f6_staticRenderFns = []
TitleLegendvue_type_template_id_626f37f6_render._withStripped = true


;// CONCATENATED MODULE: ./src/components/TitleLegend.vue?vue&type=template&id=626f37f6&

;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/TitleLegend.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ const TitleLegendvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    ohlcv: function ohlcv() {
      ...
      if (this.$props.legendDecimal) {
        return [this.$props.values.ohlcv[1].toFixed(this.$props.values.ohlcv[1] < 1 ? 3 : 2), this.$props.values.ohlcv[2].toFixed(this.$props.values.ohlcv[2] < 1 ? 3 : 2), this.$props.values.ohlcv[3].toFixed(this.$props.values.ohlcv[3] < 1 ? 3 : 2), this.$props.values.ohlcv[4].toFixed(this.$props.values.ohlcv[4] < 1 ? 3 : 2), this.$props.values.ohlcv[5] ? Number(this.$props.values.ohlcv[5].toFixed(0)).toLocaleString('en-AU') : 'n/a', this.$props.values.ohlcv[8] ? '(' + Number(this.$props.values.ohlcv[8].toFixed(2)).toLocaleString('en-AU') + '%)' : ''];
      } else {
        return [this.$props.values.ohlcv[1].toFixed(prec), this.$props.values.ohlcv[2].toFixed(prec), this.$props.values.ohlcv[3].toFixed(prec), this.$props.values.ohlcv[4].toFixed(prec), this.$props.values.ohlcv[5] ? Number(this.$props.values.ohlcv[5].toFixed(0)).toLocaleString('en-AU') : 'n/a', this.$props.values.ohlcv[8] ? '(' + Number(this.$props.values.ohlcv[8].toFixed(2)).toLocaleString('en-AU') + '%)' : ''];
      }
    },
    main_type: function main_type() {
...
;// CONCATENATED MODULE: ./src/components/TitleLegend.vue?vue&type=script&lang=js&
 /* harmony default export */ const components_TitleLegendvue_type_script_lang_js_ = (TitleLegendvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/TitleLegend.vue?vue&type=style&index=0&lang=css&
var TitleLegendvue_type_style_index_0_lang_css_ = __webpack_require__(519);
;// CONCATENATED MODULE: ./src/components/TitleLegend.vue?vue&type=style&index=0&lang=css&

;// CONCATENATED MODULE: ./src/components/TitleLegend.vue
...
var TitleLegend_component = normalizeComponent(
  components_TitleLegendvue_type_script_lang_js_,
  TitleLegendvue_type_template_id_626f37f6_render,
  TitleLegendvue_type_template_id_626f37f6_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var TitleLegend_api; }
TitleLegend_component.options.__file = "src/components/TitleLegend.vue"
...
/* harmony default export */ const TradingVuevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    resetChart: function resetChart(resetRange) {
      ...
      if (resetRange) {
        var _this$$refs, _this$$refs$chart2;

        var initRange = (_this$$refs = this.$refs) === null || _this$$refs === void 0 ? void 0 : (_this$$refs$chart2 = _this$$refs.chart) === null || _this$$refs$chart2 === void 0 ? void 0 : _this$$refs$chart2.initRange;
    ...
    updateChart: function updateChart() {//  console.log(" update chart was called")
      //       this.$nextTick(() =>
      //         this.custom_event({
      //           event: "?chart-resize",
      //           args:[]
    ...
    range_changed: function range_changed(r, manualInteraction) {
      ...
      this.$emit("range-changed", r, manualInteraction); // this.custom_event({ event: "range-changed", args: [r,r2] });
  ...
  watch: {
    decimalPlace: function decimalPlace(n) {
      var base = this.$props.data; // console.log("props:",base);
  ...
  mounted: function mounted() {
    var base = this.$props.data; // console.log("props:",this.$props.enableArrow);
...
const ww$$$_namespaceObject = JSON.parse('[""]');
...
// add the styles to the DOM
var add = __webpack_require__(346)/* .default */ .Z
var update = add("1528905d", content, false, {});
// Hot Module Replacement
if(false) {}
